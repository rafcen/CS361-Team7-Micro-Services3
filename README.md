...
Connect to port 5002 and send the server a folder path, it will reply with a 
dictionary of the images in the folder with the key being the image name and 
value being the path to the image.
